  ...
  return (
    <section id="overview" className="scroll-mt-24 pb-24 sm:pb-32">
      <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-10">
        <SectionHeading
          title="Built for the last one percent"
          description="Most generators get you close. Cortex is engineered for the part that makes people stop scrolling and ask what camera you used."
        />
      </div>
