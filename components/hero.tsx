        ...
        {Array.from({ length: STACK_COUNT }, (_, i) => {
          ...
          return (
            <motion.div
              ...
              className="border-border/30 absolute inset-0 overflow-hidden rounded-lg border"
            >
              <Image
                src={imageSrc(i * 3)}
                alt=""
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex max-w-3xl flex-col items-center px-6 text-center">
          <motion.h1
            {...fadeUp(0.2)}
            className="text-foreground mt-5 text-[clamp(32px,5vw,56px)] leading-[1.05] font-medium tracking-tight text-balance"
          >
            Welkom bij Tattoo Heaven
          </motion.h1>
          <motion.p
            {...fadeUp(0.32)}
